...
import { useOpponents, useCreateOpponent, useUpdateOpponent, useDeleteOpponent, useOpponentMatchesCount } from '@/hooks/useSupabaseData'
import { supabase } from '@/integrations/supabase/client'
import { toast } from 'sonner'
import { Plus, Trash2, Image as ImageIcon } from 'lucide-react'

const OpponentRow = ({ o, onUpdateLogo, updateOpponent, deleteOpponent }: {
  o: any;
        ...
        <CardContent className="p-4">
          <div className="space-y-3">
            {opponents.length === 0 ? (
              ...
              <OpponentRow key={o.id} o={o} onUpdateLogo={handleUpdateLogo} updateOpponent={updateOpponent} deleteOpponent={deleteOpponent} />
            ))}
          </div>
        </CardContent>
      </Card>

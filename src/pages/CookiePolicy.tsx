...
const CookiePolicy = () => {
  ...
  useEffect(() => {
    ...
    // Trova il container e aggiungi lo script
    const container = document.getElementById('CookieDeclaration-container');
    if (container) {
      // Pulisci il container prima di aggiungere lo script
      container.innerHTML = '';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card className="shadow-lg">
          ...
          <CardContent className="prose prose-slate max-w-none">
            {/* Container per script Cookiebot - popolato da useEffect */}
            <div 

              ...
              <div className="space-y-3">
                {getTrialistsByStatus(column.id).map((trialist) => (
                  <Card
                    ...
                    draggable
                    onDragStart={(e) => handleDragStart(e, trialist)}
                  >
                    ...
                    <div className="flex items-center space-x-1 mt-3">
                      {column.id === 'in_prova' && (
                        <>
                          <Button
                            ...
                            onClick={() => handleStatusChange(trialist.id, 'promosso')}
                          >
                          ...
                          <Button
                            ...
                            variant="outline"
                            className="flex-1 text-xs"
                            onClick={() => handleStatusChange(trialist.id, 'archiviato')}
                          >
                      ...
                      {column.id === 'promosso' && (
                        <Button
                          ...
                          onClick={() => handleStatusChange(trialist.id, 'in_prova')}
                        >
                          <ArrowRight className="h-3 w-3 mr-1" />
                          Riporta in prova
                        </Button>
                      )}
                      {column.id === 'archiviato' && (
                        <Button
                          size="sm"
                          variant="outline"
                          className="w-full text-xs"

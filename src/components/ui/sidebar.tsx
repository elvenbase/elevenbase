  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-dvh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex overscroll-contain",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-dvh flex-1 min-w-0 flex-col bg-background overflow-x-hidden",

...
interface EditPlayerFormProps {
  player: Player
  // Props per uso controllato (opzionali)
  isOpen?: boolean
  onClose?: () => void
  onUpdate?: () => void
  // Props per pattern children
...
export const EditPlayerForm: React.FC<EditPlayerFormProps> = ({
  ...
  // Stato interno per gestire la modal quando usato con children
  const [internalIsOpen, setInternalIsOpen] = useState(false)
  
  // Determina se stiamo usando il pattern controllato o quello con children
  ...
  // Se abbiamo children, usa il pattern trigger, altrimenti usa il pattern controllato
  if (children) {
    return (
      <Dialog open={isOpen} onOpenChange={setInternalIsOpen}>
